...
struct ListNode {
  ...
  ListNode(ValueType v, ValueType t, ListNode* nxt=0)
    : val(v), type(t), next(nxt) {}
};

ListNode* front = nullptr;
ListNode* rear = nullptr;

void append(ListNode*& front, ListNode*& rear, ValueType x, ValueType t)
{
  ListNode* n = new ListNode(x, t);
  if (rear != nullptr) {
    rear->next = n;
    rear = n;
  } else {
...
int main()
{
  int m, id, served, remaining=0, t, flavor[20];
